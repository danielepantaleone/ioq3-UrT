...
typedef struct {
    ...
    int             spreeCount;     // used for spree counter
    int             spawnCount;     // used for spree counter
...
int        SCR_GetSmallStringWidth( const char *str );    // returns in virtual 640x480 coordinates
