...
/////////////////////////////////////////////////////////////////////
// Name        : SV_ClipHandleForEntity
// Description : Returns a headnode that can be used for testing or 
//               clipping to a given entity.  If the entity is a bsp 
//               model, the headnode will be returned, otherwise a 
//               custom box tree will be constructed.
/////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_SectorList_f
// Description : Print the list of sectors
/////////////////////////////////////////////////////////////////////
...
// Description : Unlink an entity form the current world
/////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_LinkEntity
// Description : Link an entity to the current world
/////////////////////////////////////////////////////////////////////
void SV_LinkEntity(sharedEntity_t *gEnt) {
    ...
    if (gEnt->r.bmodel) {
        ...
        i = (int)Com_Clamp(1, 255, gEnt->r.maxs[0]);

        // z is not symetric
        j = (int)Com_Clamp(1, 255, -gEnt->r.mins[2]);

        // and z maxs can be negative...
        k = (int)Com_Clamp(1, 255, gEnt->r.maxs[2] + 32);
...
void SV_ClipToEntity(trace_t *trace, const vec3_t start, const vec3_t mins, const vec3_t maxs, 
    ...
    CM_TransformedBoxTrace (trace, (float *)start, (float *)end, (float *)mins, (float *)maxs, 
                            clipHandle,  contentmask, origin, angles, capsule);
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_Trace
// Description : Moves the given mins/maxs volume through the world 
//               from start to end. passEntityNum and entities owned 
//               by passEntityNum are explicitly not checked.
/////////////////////////////////////////////////////////////////////
