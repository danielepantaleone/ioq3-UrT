...
/////////////////////////////////////////////////////////////////////
// Name        : SV_SendConfigstring
// Description : Creates and sends the server command necessary to 
//               update the CS index for the given client
/////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_UpdateConfigstrings
// Description : Called when a client goes from CS_PRIMED to 
//               CS_ACTIVE.  Updates all Configstring indexes that 
//               have changed while the client was in CS_PRIMED
/////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_SetConfigstring
// Description : Set a config string
/////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_GetConfigstring
// Description : Get a value from a config string
/////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_SetUserinfo
// Description : Set the client userinfo string
/////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_CreateBaseline
// Description : Entity baselines are used to compress non-delta 
//               messages to the clients -- only the fields that 
//               differ from the baseline will be transmitted
/////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_Startup
// Description : Called when a host starts a map when it wasn't 
//               running one before.  Successive map or map_restart 
//               commands will NOT cause this to be called, unless 
//               the game is exited to the menu system first.
/////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_ChangeMaxClients
// Description : Change the max clients on the server
/////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_ClearServer
// Description : Clear server config strings
/////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
// Name        : TextEncode6Bit
// Description : Encodes text using 6 bit alphabet for map names
// Author      : r00t
/////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_MakeCompressedPureList
// Description : Fills the last N configstrings with compressed 
//               pure list
// Author      : r00t
/////////////////////////////////////////////////////////////////////
int SV_MakeCompressedPureList() {
    ...
    // do 8bit to 7bit encoding, escaping \0 % " 
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_Init
// Description : Only called at main exe startup, not for each game
/////////////////////////////////////////////////////////////////////
void SV_Init(void) {
    ...
    sv_skeetspeed = Cvar_Get("sv_skeetspeed", "0", CVAR_ARCHIVE);
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_FinalMessage
// Description : Used by SV_Shutdown to send a final message to all
//               connected clients before the server goes down. 
//               The messages are sent immediately,
//               not just stuck on the outgoing message list, because 
//               the server is going to totally exit after returning 
//               from this function.
/////////////////////////////////////////////////////////////////////
        ...
        for (i = 0, cl = svs.clients; i < sv_maxclients->integer; i++, cl++) {
            ...
            if (cl->state >= CS_CONNECTED) {
                ...
                if (cl->netchan.remoteAddress.type != NA_LOOPBACK) {
                    SV_BroadcastMessageToClient(cl, message);
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_Shutdown
// Description : Called when each game quits, 
