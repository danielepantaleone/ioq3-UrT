...
/////////////////////////////////////////////////////////////////////
// Name        : SV_Netchan_Encode
// Description : Encode a message to be transmitted. First four bytes 
//               of the data are always: 
//
...
static void SV_Netchan_Encode(client_t *client, msg_t *msg) {
    ...
    for (i = SV_ENCODE_START; i < msg->cursize; i++) {
        ...
        // this message acknowledged client command
        if (!string[index]) {
            index = 0;
        }
...
/////////////////////////////////////////////////////////////////////
// Name        : SV_Netchan_Decode
// Description : Decode a message. First 12 bytes of the data 
//               are always:
//
//                  long serverId;
