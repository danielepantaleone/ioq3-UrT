...
#define SKEET_SCORE_DST_1       5000
#define SKEET_SCORE_DST_2       6500
...
typedef struct client_s {
    ...
    int             reliableSequence;                   // last added reliable message, 
                                                        // not necesarily sent or acknowledged yet
    int             messageAcknowledge;
    int             reliableAcknowledge;                // last acknowledged reliable message
    int             reliableSent;                       // last sent reliable message, 
                                                        // not necesarily acknowledged yet
    ...
    int             lastReliableTime;       // svs.time of the last reliable command received
    ...
    int                 timeoutCount;             // must timeout a few frames in a row 
...
// MAX_INFO_RECEIPTS is the maximum number of getstatus + getinfo 
// responses that we send in a two second time period.
...
// called after the world model has been loaded, 
// before linking any entities
...
// Needs to be called any time an entity changes origin, mins, 
// maxs, or solid.  Automatically unlinks if needed.
